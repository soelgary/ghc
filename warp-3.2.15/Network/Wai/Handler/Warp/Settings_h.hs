...
import Control.Concurrent (forkIOWithUnmask, hForkOnWithUnmask, ThreadId(..), myThreadId, killThread)
...
data Settings = Settings
    ...
    , settingsFork :: Int -> Int -> Int -> ((forall a. IO a -> IO a) -> IO ()) -> IO ThreadId
